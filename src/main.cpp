...
uint256 hashGenesisBlock("0x42a51f5db23f816e753aba7e9271a89aed89779be9b24519f5dfa53c3a4a5474");
...
const string strMessageMagic = "newcenturycoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 720) // extra block reward within the first day
        nSubsidy = 1000 * COIN;
    if(nHeight >= 720 && nHeight <= 7200) // extra block reward days 2-10
        nSubsidy = 500 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 0.5 * 24 * 60 * 60; // newcenturycoin: 0.5 days
static const int64 nTargetSpacing = 120; // newcenturycoin: 120 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal newcenturycoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "newcenturycoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd9c36ed67c166da864087e53c474d1bcab813f8ed8f3e22de31c90bc5acbfe1e");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Today is Febuary 26 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1393640080;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 520892;

        if (fTestNet)
        {
            block.nTime    = 1393436940;
            block.nNonce   = 2678962;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xdb84ce876b486dc9ced7d5e40fd25e686fb5e0d57767734b547ac505708e300a"));
